        ...
        for ID in correctAnswer:
            if len(correctAnswer[ID]) == 1 and correctAnswer[ID][0] != 'true' and correctAnswer[ID][0] != 'false':
                ...
                try:
                    ...
                    print(f'line: 75 未找到元素 xpath://*[@id="app"]/div/div[1]/div[2]/div/div[1]/div/div/ul/li[{ID+1}]/div[2]/ul/li[{answer}]/div/label/span[1]/input, 可能是源代码出现问题\n按任意键继续...')
                    msvcrt.getch()
                    continue
                ...
                for length in range(len(correctAnswer[ID])):
                    ...
                    try:
                        ...
                        print(f'line: 86 未找到元素 xpath://*[@id="app"]/div/div[1]/div[2]/div/div[1]/div/div/ul/li[{ID + 1}]/div[2]/ul/li[{answer}]/div/label/span[1]/input, 可能是源代码出现问题\n按任意键继续...')
                        msvcrt.getch()
                        continue
                ...
                try:
                    ...
                    print(f'line: 95 未找到元素 xpath://*[@id="app"]/div/div[1]/div[2]/div/div[1]/div/div/ul/li[{ID + 1}]/div[2]/ul/li[{answer}]/div/label/span[1]/input, 可能是源代码出现问题\n按任意键继续...')
                    msvcrt.getch()
                    continue
        print('自动答题完成！按任意键继续')
        msvcrt.getch()
